...
import type { LinkRotScanAlertActivities } from "#activities/maintenance/link-rot/link-rot-scan-alerts.ts";
...
} from "#activities/maintenance/link-rot/link-rot-scan-report.ts";
