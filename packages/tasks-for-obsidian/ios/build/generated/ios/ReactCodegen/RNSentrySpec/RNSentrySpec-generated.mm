...
namespace facebook::react {
    ...
    static facebook::jsi::Value __hostFunction_NativeRNSentrySpecJSI_setAttribute(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, VoidKind, "setAttribute", @selector(setAttribute:value:), args, count);
    }

    static facebook::jsi::Value __hostFunction_NativeRNSentrySpecJSI_setAttributes(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
  ...
  NativeRNSentrySpecJSI::NativeRNSentrySpecJSI(const ObjCTurboModule::InitParams &params)
    : ObjCTurboModule(params) {
        ...
        methodMap_["setAttribute"] = MethodMetadata {2, __hostFunction_NativeRNSentrySpecJSI_setAttribute};
