...
| Scout     | `ai_reports_enabled`, `ai_reports_unlimited`, `ai_reviews_enabled`, `betting_enabled`, `debug`                                                                                                                                                               | Boolean; guild/user context on every evaluation | `packages/backend/src/configuration/flags.ts` |
