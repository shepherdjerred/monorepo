...
export function visit<T>(
  ...
  switch (expr.type) {
    case "Undefined":
      return visitor.visitUndefined(expr);
    case "Null":
      return visitor.visitNull(expr);
    case "Boolean":
      return visitor.visitBoolean(expr);
    case "Number":
    ...
    case "Property":
      return visitor.visitProperty(expr);
    case "Index":
      return visitor.visitIndex(expr);
    case "Application":
      return visitor.visitApplication(expr);
    case "UnaryOperation":
      return visitor.visitUnaryOperation(expr);
    case "BinaryOperation":
      return visitor.visitBinaryOperation(expr);
    case "ArrayConstruction":
      return visitor.visitArrayConstruction(expr);
    case "ObjectConstruction":
      return visitor.visitObjectConstruction(expr);
  }
}
