import { PersonalityMetadataSchema, type Personality } from "@shepherdjerred/scout-data/index";
import { createLogger } from "@shepherdjerred/scout-backend/logger.ts";

// Static imports for lane context files
import topLane from "@shepherdjerred/scout-data/src/review/prompts/lanes/top.txt";
import middleLane from "@shepherdjerred/scout-data/src/review/prompts/lanes/middle.txt";
import jungleLane from "@shepherdjerred/scout-data/src/review/prompts/lanes/jungle.txt";
import adcLane from "@shepherdjerred/scout-data/src/review/prompts/lanes/adc.txt";
import supportLane from "@shepherdjerred/scout-data/src/review/prompts/lanes/support.txt";
import genericLane from "@shepherdjerred/scout-data/src/review/prompts/lanes/generic.txt";
...
function getPromptsDir(): string {
  ...
  const dataPackageUrl = import.meta.resolve("@shepherdjerred/scout-data");
