...
<!-- temporal-agent-task
{
  ...
  "checks": [
    { "id": "deployed-revision", "label": "Deployed revision", "required": true, "evidenceRequirement": "Current ArgoCD and checkout Git revision evidence.", "evidenceCollectors": [{ "id": "git-revision", "kind": "command", "argv": ["git", "rev-parse", "HEAD"], "output": "non-empty" }, { "id": "argocd-root", "kind": "command", "argv": ["argocd", "app", "get", "apps", "-o", "json"], "output": "json" }] },
    { "id": "capacity-runtime", "label": "Capacity and runtime health", "required": true, "evidenceRequirement": "Current Buildkite, Kubernetes, Kueue, and Temporal evidence.", "evidenceCollectors": [{ "id": "main-builds", "kind": "command", "argv": ["bk", "build", "list", "--pipeline", "monorepo", "--branch", "main", "--limit", "5"], "output": "non-empty" }, { "id": "workloads", "kind": "command", "argv": ["kubectl", "get", "pods", "-A", "-o", "json"], "output": "json" }, { "id": "kueue-state", "kind": "command", "argv": ["kubectl", "get", "clusterqueues.kueue.x-k8s.io,localqueues.kueue.x-k8s.io", "-A", "-o", "json"], "output": "json" }, { "id": "temporal-schedules", "kind": "command", "argv": ["temporal", "schedule", "list", "--output", "json"], "output": "json" }] },
    { "id": "observability", "label": "Metrics and dashboards", "required": true, "evidenceRequirement": "Successful current Prometheus capacity queries and a zero-error dashboard audit.", "evidenceCollectors": [{ "id": "kueue-backlog", "kind": "prometheus", "query": "sum(kueue_pending_workloads{cluster_queue=\"buildkite\"})" }, { "id": "liskov-memory", "kind": "prometheus", "query": "node_memory_MemAvailable_bytes{node=\"liskov\"}" }, { "id": "pod-restarts", "kind": "prometheus", "query": "sum(kube_pod_container_status_restarts_total)" }, { "id": "dashboard-audit", "kind": "command", "argv": ["bun", "packages/homelab/src/cdk8s/scripts/grafana-dashboard-audit.ts"], "output": "json" }] },
    { "id": "storage-thermals", "label": "Storage and thermals", "required": true, "evidenceRequirement": "Current PVC, ZFS, disk-I/O, and AMD Tctl evidence.", "evidenceCollectors": [{ "id": "pvc-inventory", "kind": "command", "argv": ["kubectl", "get", "pvc", "-A", "-o", "json"], "output": "json" }, { "id": "zpool-status", "kind": "command", "argv": ["zpool", "status"], "output": "non-empty" }, { "id": "disk-io", "kind": "prometheus", "query": "rate(node_disk_io_time_seconds_total{node=\"liskov\"}[5m])" }, { "id": "amd-tctl", "kind": "prometheus", "query": "node_hwmon_temp_celsius{node=\"liskov\"} and on(chip,sensor) node_hwmon_sensor_label{node=\"liskov\",label=\"Tctl\"}" }] }
  ],
  "source": {
...
<!-- temporal-agent-task
{
  ...
  "repo": { "fullName": "shepherdjerred/monorepo", "ref": "main" },
  "checks": [
    { "id": "deployed-revision", "label": "Deployed revision and window", "required": true, "evidenceRequirement": "Current ArgoCD and checkout Git revision evidence.", "evidenceCollectors": [{ "id": "git-revision", "kind": "command", "argv": ["git", "rev-parse", "HEAD"], "output": "non-empty" }, { "id": "argocd-root", "kind": "command", "argv": ["argocd", "app", "get", "apps", "-o", "json"], "output": "json" }] },
    { "id": "capacity-runtime", "label": "Capacity and runtime gates", "required": true, "evidenceRequirement": "Buildkite, Kubernetes, Kueue, and 24-hour admission evidence.", "evidenceCollectors": [{ "id": "main-builds", "kind": "command", "argv": ["bk", "build", "list", "--pipeline", "monorepo", "--branch", "main", "--limit", "20"], "output": "non-empty" }, { "id": "workloads", "kind": "command", "argv": ["kubectl", "get", "pods", "-A", "-o", "json"], "output": "json" }, { "id": "kueue-state", "kind": "command", "argv": ["kubectl", "get", "clusterqueues.kueue.x-k8s.io,localqueues.kueue.x-k8s.io", "-A", "-o", "json"], "output": "json" }, { "id": "admission-p95", "kind": "prometheus", "query": "histogram_quantile(0.95, sum by (le) (rate(kueue_admission_wait_time_seconds_bucket{cluster_queue=\"buildkite\"}[30m])))", "windowSeconds": 86400, "stepSeconds": 300 }] },
    { "id": "observability", "label": "Metrics and dashboards", "required": true, "evidenceRequirement": "Successful 24-hour Prometheus health queries and a zero-error dashboard audit.", "evidenceCollectors": [{ "id": "kueue-backlog", "kind": "prometheus", "query": "sum(kueue_pending_workloads{cluster_queue=\"buildkite\"})", "windowSeconds": 86400, "stepSeconds": 300 }, { "id": "liskov-memory", "kind": "prometheus", "query": "node_memory_MemAvailable_bytes{node=\"liskov\"}", "windowSeconds": 86400, "stepSeconds": 300 }, { "id": "pod-restarts", "kind": "prometheus", "query": "sum(kube_pod_container_status_restarts_total)", "windowSeconds": 86400, "stepSeconds": 300 }, { "id": "dashboard-audit", "kind": "command", "argv": ["bun", "packages/homelab/src/cdk8s/scripts/grafana-dashboard-audit.ts"], "output": "json" }] },
    { "id": "storage-thermals", "label": "Storage and thermals", "required": true, "evidenceRequirement": "PVC, ZFS, disk-I/O, and AMD Tctl evidence for the full 24-hour window.", "evidenceCollectors": [{ "id": "pvc-inventory", "kind": "command", "argv": ["kubectl", "get", "pvc", "-A", "-o", "json"], "output": "json" }, { "id": "zpool-status", "kind": "command", "argv": ["zpool", "status"], "output": "non-empty" }, { "id": "disk-io", "kind": "prometheus", "query": "rate(node_disk_io_time_seconds_total{node=\"liskov\"}[5m])", "windowSeconds": 86400, "stepSeconds": 300 }, { "id": "amd-tctl", "kind": "prometheus", "query": "node_hwmon_temp_celsius{node=\"liskov\"} and on(chip,sensor) node_hwmon_sensor_label{node=\"liskov\",label=\"Tctl\"}", "windowSeconds": 86400, "stepSeconds": 300 }] }
  ],
  "source": {
    "docPath": "packages/docs/todos/homelab-capacity-rollout-acceptance.md"
  },
...
<!-- temporal-agent-task
{
  ...
  "repo": { "fullName": "shepherdjerred/monorepo", "ref": "main" },
  "checks": [
    { "id": "deployed-revision", "label": "Deployed revision and soak window", "required": true, "evidenceRequirement": "Current ArgoCD and checkout Git revision evidence.", "evidenceCollectors": [{ "id": "git-revision", "kind": "command", "argv": ["git", "rev-parse", "HEAD"], "output": "non-empty" }, { "id": "argocd-root", "kind": "command", "argv": ["argocd", "app", "get", "apps", "-o", "json"], "output": "json" }] },
    { "id": "capacity-runtime", "label": "Capacity and runtime gates", "required": true, "evidenceRequirement": "Buildkite, Kubernetes, Kueue, and seven-day admission evidence.", "evidenceCollectors": [{ "id": "main-builds", "kind": "command", "argv": ["bk", "build", "list", "--pipeline", "monorepo", "--branch", "main", "--limit", "50"], "output": "non-empty" }, { "id": "workloads", "kind": "command", "argv": ["kubectl", "get", "pods", "-A", "-o", "json"], "output": "json" }, { "id": "kueue-state", "kind": "command", "argv": ["kubectl", "get", "clusterqueues.kueue.x-k8s.io,localqueues.kueue.x-k8s.io", "-A", "-o", "json"], "output": "json" }, { "id": "admission-p95", "kind": "prometheus", "query": "histogram_quantile(0.95, sum by (le) (rate(kueue_admission_wait_time_seconds_bucket{cluster_queue=\"buildkite\"}[30m])))", "windowSeconds": 604800, "stepSeconds": 300 }] },
    { "id": "observability", "label": "Metrics and dashboards", "required": true, "evidenceRequirement": "Successful seven-day Prometheus health queries and a zero-error dashboard audit.", "evidenceCollectors": [{ "id": "kueue-backlog", "kind": "prometheus", "query": "sum(kueue_pending_workloads{cluster_queue=\"buildkite\"})", "windowSeconds": 604800, "stepSeconds": 300 }, { "id": "liskov-memory", "kind": "prometheus", "query": "node_memory_MemAvailable_bytes{node=\"liskov\"}", "windowSeconds": 604800, "stepSeconds": 300 }, { "id": "pod-restarts", "kind": "prometheus", "query": "sum(kube_pod_container_status_restarts_total)", "windowSeconds": 604800, "stepSeconds": 300 }, { "id": "dashboard-audit", "kind": "command", "argv": ["bun", "packages/homelab/src/cdk8s/scripts/grafana-dashboard-audit.ts"], "output": "json" }] },
    { "id": "storage-thermals", "label": "Storage and thermals", "required": true, "evidenceRequirement": "PVC, ZFS, disk-I/O, and AMD Tctl evidence for the full seven-day soak.", "evidenceCollectors": [{ "id": "pvc-inventory", "kind": "command", "argv": ["kubectl", "get", "pvc", "-A", "-o", "json"], "output": "json" }, { "id": "zpool-status", "kind": "command", "argv": ["zpool", "status"], "output": "non-empty" }, { "id": "disk-io", "kind": "prometheus", "query": "rate(node_disk_io_time_seconds_total{node=\"liskov\"}[5m])", "windowSeconds": 604800, "stepSeconds": 300 }, { "id": "amd-tctl", "kind": "prometheus", "query": "node_hwmon_temp_celsius{node=\"liskov\"} and on(chip,sensor) node_hwmon_sensor_label{node=\"liskov\",label=\"Tctl\"}", "windowSeconds": 604800, "stepSeconds": 300 }] }
  ],
  "source": {
    "docPath": "packages/docs/todos/homelab-capacity-rollout-acceptance.md"
  },
