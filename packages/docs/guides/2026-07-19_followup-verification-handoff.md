...
| 4   | PR babysitter live                                  | ~~Flag `PR_BABYSIT_ENABLED="true"` since PR #1342~~ — **feature removed 2026-07-30** | None — the pr-babysit feature was removed entirely (see `archive/completed/babysit-phase4-live-retest.md`). No live verification needed.                                                   | —                                    |
...
- Turbo remote cache — Buildkite main build #6529 reported 186 of 191 tasks
  cached, and the server logged successful artifact PUTs on 2026-07-27.
- PagerDuty alert formatting — incidents #6828, #6831, and #6824 verified
  single-line titles and per-alert bodies in Custom Details on 2026-07-27.
...
- **Scout PR-B fact-table drop** — PR #1514 subsequently merged and removed the
  report-store tables, including the timeline mirror; closure evidence is in
  `archive/completed/scout-report-lake-fact-table-drop.md`.
