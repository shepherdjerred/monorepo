...
import type { WorkflowFailureWatchActivities } from "#activities/maintenance/workflow-failure/workflow-failure-watch-activity.ts";
 ...
 * src/activities/maintenance/workflow-failure-watch-activity.ts.
 */
