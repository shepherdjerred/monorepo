...
import { asTextChannel } from "@shepherdjerred/scout-backend/discord/utils/channel.ts";
import {
  checkSendMessagePermission,
  isPermissionError,
  formatPermissionErrorForLog,
  notifyServerOwnerAboutPermissionError,
} from "@shepherdjerred/scout-backend/discord/utils/permissions.ts";
import { discordPermissionErrorsTotal } from "@shepherdjerred/scout-backend/metrics/index.ts";
import { prisma } from "@shepherdjerred/scout-backend/database/index.ts";
import {
  recordPermissionError,
  recordSuccessfulSend,
} from "@shepherdjerred/scout-backend/database/guild-permission-errors.ts";
import type { DiscordChannelId, DiscordGuildId } from "@shepherdjerred/scout-data/index";
