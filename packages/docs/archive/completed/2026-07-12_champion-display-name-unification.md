...
are used across data, backend, app, report, and frontend surfaces.

## Comment Log

- 2026-07-27 — Board audit verified `championNameToDisplayName` and
  `getChampionDisplayNameById` are present and consumed across the intended
  packages. Closed and archived as implemented.
