...
import type { ScoutQlQueryAst } from "#src/model/scoutql/parse/ast.ts";
import { collapsedSpan } from "#src/model/scoutql/parse/ast.ts";
import { scoutQlCstToAst } from "#src/model/scoutql/parse/cst-to-ast.ts";
import { ScoutQlCstParser } from "#src/model/scoutql/parse/parser.ts";
import {
  Case,
  LParen,
  Minus,
