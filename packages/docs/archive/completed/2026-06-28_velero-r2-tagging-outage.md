...
- The outage, rollback, orphan cleanup, and capacity recovery are complete. Upstream unpinning and the privileged R2 lifecycle backstop are isolated TODOs.

### Remaining

- Residual work is owned by `todos/velero-aws-plugin-r2-tagging.md`, `todos/velero-r2-lifecycle-backstop.md`.
