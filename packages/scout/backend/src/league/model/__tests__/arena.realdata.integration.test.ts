...
import type { RawMatch, Player } from "@shepherdjerred/scout-data";
import { ArenaMatchSchema, LeaguePuuidSchema, RawMatchSchema } from "@shepherdjerred/scout-data";
import { toArenaMatch } from "@shepherdjerred/scout-backend/league/model/match.ts";
