...
- PR #1514 is merged and the seven report-store tables are absent from the current schema; this TODO is complete.
- The removed `StoredMatchTimeline.rawJson` mirror was approximately 78% of the
  11 GB SQLite database in the July 4 measurement. Its removal also closes the
  duplicate `scout-timeline-pvc-growth` capacity-risk record; canonical
  timeline JSON remains in S3.
