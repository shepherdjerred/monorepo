      ...
      <article className="message is-danger">
        ...
        <div className="message-body">
          <p className="confirmation-message">
            Are you sure you want to delete {club.name}? This action cannot be
            undone.
          </p>
          <nav className="level">
            ...
            <div className="level-right">
              <div className="buttons">
                <a className="button is-danger" onClick={this.onDelete}>
                  Delete
                </a>
                <a className="button" onClick={this.onCancel}>
                  Cancel
                </a>
              </div>
            </div>
