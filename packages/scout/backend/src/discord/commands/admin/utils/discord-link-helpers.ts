...
import type { DiscordAccountId, DiscordGuildId } from "@shepherdjerred/scout-data";
...
export async function executeDiscordLinkOperation(
  ...
  try {
    ...
    const { buildDatabaseError } = await import("@shepherdjerred/scout-backend/discord/commands/admin/utils/responses.js");
