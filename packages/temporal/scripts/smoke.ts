...
const CLI_CHECKS: readonly { name: string; args: readonly string[] }[] = [
  ...
  { name: "toolkit grafana", args: ["toolkit", "grafana", "--version"] },
  { name: "toolkit prom", args: ["toolkit", "prom", "--help"] },
  { name: "toolkit loki", args: ["toolkit", "loki", "--help"] },
  { name: "toolkit tempo", args: ["toolkit", "tempo", "--help"] },
  {
    name: "toolkit temporal",
    args: ["toolkit", "temporal", "--version"],
  },
  {
    name: "toolkit argocd",
    args: ["toolkit", "argocd", "version", "--client"],
  },
