...
import { getCompetitionById } from "@shepherdjerred/scout-backend/database/competition/queries.ts";
...
import { send as sendChannelMessage } from "@shepherdjerred/scout-backend/league/discord/channel.ts";
