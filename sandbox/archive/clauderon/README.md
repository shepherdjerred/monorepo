...
A Rust-based session manager for running isolated Claude Code or Codex sessions in Docker containers.

## Features

- **Session Isolation**: Run Claude Code or Codex in isolated Docker containers with Git worktrees
- **Container Isolation**: Run agents in isolated Docker containers with no access to host credentials
...
Files that remain on the host only:
