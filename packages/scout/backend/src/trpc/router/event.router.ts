...
import { router, desktopClientProcedure } from "@shepherdjerred/scout-backend/trpc/trpc.ts";
...
import { selectSoundForEvent, type EventContext } from "@shepherdjerred/scout-backend/sound-engine/index.ts";
import { voiceManager } from "@shepherdjerred/scout-backend/voice/index.ts";
import type { SoundPack, SoundPackSettings, DefaultSounds, SoundRule, SoundPackId } from "@shepherdjerred/scout-data";
