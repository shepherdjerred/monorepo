...
describe("custom participant anonymization", () => {
  ...
  test("detects participants in pending voice work", () => {
    ...
    expect(
      pendingCustomResultVoiceIncludesParticipant(payload, "12345678901234567"),
    ).toBe(true);
    expect(
      pendingCustomResultVoiceIncludesParticipant(payload, "98765432109876543"),
    ).toBe(true);
    expect(
      pendingCustomResultVoiceIncludesParticipant(payload, "88765432109876543"),
    ).toBe(false);
  });
});
