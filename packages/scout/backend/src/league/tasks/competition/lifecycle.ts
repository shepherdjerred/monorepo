import type { CompetitionWithCriteria } from "@shepherdjerred/scout-data/index";
import { parseCompetition } from "@shepherdjerred/scout-data/index";
import { prisma } from "@shepherdjerred/scout-backend/database/index.ts";
import { createSnapshotsForAllParticipants } from "@shepherdjerred/scout-backend/league/competition/snapshots.ts";
import {
