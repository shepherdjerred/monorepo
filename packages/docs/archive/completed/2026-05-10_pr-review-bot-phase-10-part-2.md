---
id: reference-completed-2026-05-10-pr-review-bot-phase-10-part-2
type: reference
status: complete
board: false
---
...
> **REMOVED 2026-07-03.** The continuous-eval workflow, cron schedules, and alerts described
> here were deleted from the repo in full — workflows, activities, the `pr_review_eval` Postgres
> DB, and the `pr-review-bot-eval` PagerDuty alerts. This doc is retained only as historical
> design context. See `packages/docs/plans/2026-07-03_remove-pr-review-eval-bot.md`.
