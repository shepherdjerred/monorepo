...
} from "@shepherdjerred/scout-backend/discord/commands/subscription/add-helpers.ts";
import {
  buildSubscriptionResponse,
  createSubscriptionRecords,
  handleWelcomeMatch,
  validateSubscriptionArgs,
} from "@shepherdjerred/scout-backend/discord/commands/subscription/add-helpers-internal.ts";
