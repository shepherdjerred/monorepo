...
- The proposed implementation depends on removed Dagger and generated-pipeline architecture, and no Windows release lane exists. A fresh static-Buildkite design is required if revived.
