...
import { createCompetition, type CreateCompetitionInput } from "@shepherdjerred/scout-backend/database/competition/queries.ts";
import { addParticipant, getParticipantStatus } from "@shepherdjerred/scout-backend/database/competition/participants.ts";
import { validateOwnerLimit, validateServerLimit } from "@shepherdjerred/scout-backend/database/competition/validation.ts";
import { canCreateCompetition, grantPermission } from "@shepherdjerred/scout-backend/database/competition/permissions.ts";
import { clearAllRateLimits } from "@shepherdjerred/scout-backend/database/competition/rate-limit.ts";
import type { CompetitionId, DiscordAccountId, DiscordGuildId, PlayerId } from "@shepherdjerred/scout-data";

import { testGuildId, testAccountId, testChannelId } from "@shepherdjerred/scout-backend/testing/test-ids.ts";
import { createTestDatabase, deleteIfExists } from "@shepherdjerred/scout-backend/testing/test-database.ts";
