function showPopup(name, text) {
  ...
  document.querySelector(
    "body > div > div.page-content.management > div.bio > h1",
  ).innerHTML = name;
  document.querySelector(
    "body > div > div.page-content.management > div.bio > p",
  ).innerHTML = text;
  console.log("show");
}
