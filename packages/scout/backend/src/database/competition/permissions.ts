import { type DiscordAccountId, type DiscordGuildId, type PermissionType } from "@shepherdjerred/scout-data";
...
import { checkRateLimit, getTimeRemaining } from "@shepherdjerred/scout-backend/database/competition/rate-limit.ts";
