...
import { createCompetition, getCompetitionById } from "@shepherdjerred/scout-backend/database/competition/queries.ts";
import type { CreateCompetitionInput } from "@shepherdjerred/scout-backend/database/competition/queries.ts";
...
import {
  ...
  type DiscordGuildId,
  type PlayerId,
} from "@shepherdjerred/scout-data/index";
...
describe("Competition View - ACTIVE Status", () => {
  ...
  test("should handle ACTIVE competition with participants", async () => {
    ...
    const { calculateLeaderboard } = await import("@shepherdjerred/scout-backend/league/competition/leaderboard.js");
