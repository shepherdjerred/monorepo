    ...
    return (
      <div>
        ...
        {!this.props.isFetching && this.props.error && (
          <ErrorNotification
            title={this.props.error.name}
            message={this.props.error.message}
            stack={this.props.error.stack}
          />
        )}
        <Form
          onSubmit={(values) => this.props.onSave(values)}
          ...
          {(formApi) => (
            <form onSubmit={formApi.submitForm}>
              <div className="field">
                ...
                <div className="control">
                  <Text
                    className={classNames({
                      input: true,
                      "is-danger": formApi.errors && formApi.errors.name,
                    })}
                    field="name"
                ...
                {formApi.errors && (
                  <p className="help is-danger">{formApi.errors.name}</p>
                )}
              </div>
              <div className="field">
                ...
                <div className="control">
                  <Text
                    className={classNames({
                      input: true,
                      "is-danger": formApi.errors && formApi.errors.shortName,
                    })}
                    field="shortName"
                ...
                {formApi.errors && (
                  <p className="help is-danger">{formApi.errors.shortName}</p>
                )}
              </div>
              <div className="field is-grouped">
                ...
                <p className="control">
                  <a className="button is-danger" onClick={this.onCancel}>
                    Cancel
                  </a>
                </p>
              </div>
