---
id: reference-homelab-audits-2026-04-05-homelab-health-audit
type: reference
status: complete
board: false
---
...
Both backends: `CreateContainerConfigError` — `RIOT_API_KEY` not set. Secret injection failing due to 1Password.
...
| KubeDeploymentRolloutStuck     | scout-beta, scout-prod                        |
