import { Card, CardContent, CardHeader, CardTitle } from "@shepherdjerred/scout-frontend/components/review-tool/ui/card";
import { Input } from "@shepherdjerred/scout-frontend/components/review-tool/ui/input";
import { Label } from "@shepherdjerred/scout-frontend/components/review-tool/ui/label";
import { Switch } from "@shepherdjerred/scout-frontend/components/review-tool/ui/switch";
import type { ImageGenerationStageConfig } from "@shepherdjerred/scout-frontend/lib/review-tool/config/schema";
import { IMAGE_GENERATION_USER_PROMPT } from "@shepherdjerred/scout-data";
