...
description: Search Generation III Pokémon species, types, evolution lineage, capture rate, and Emerald level-up moves. Use when a goal depends on a Pokémon's identity or capabilities.
---
