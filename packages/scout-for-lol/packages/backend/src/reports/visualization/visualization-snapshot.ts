...
import { comparePatchLabels } from "#src/reports/schedule/temporal-labels.ts";
import {
  planTemporalGrouping,
  planTemporalSpec,
  rangeIsBounded,
} from "#src/reports/schedule/temporal-plan.ts";
import { assertProjectedPointCount } from "#src/reports/visualization/visualization-buckets.ts";
import {
...
} from "#src/reports/visualization/visualization-points.ts";
import { normalizePercentStack } from "#src/reports/visualization/visualization-series-transforms.ts";
import { rankBumpSeries } from "#src/reports/visualization/visualization-bump-ranks.ts";
