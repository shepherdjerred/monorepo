...
import type { SummarizedChunk } from "#activities/glitter/context/refresh/style/glitter-context-refresh-style-generation-cost.ts";
import { priorFieldValues } from "#activities/glitter/context/refresh/style/glitter-context-refresh-style-finalize.ts";
import {
  STYLE_ARRAY_FIELDS,
  type StyleSynthesis,
