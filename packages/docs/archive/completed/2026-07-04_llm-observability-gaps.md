...
- PR #1403 merged the capture tranche. Scout Mastra tracing, cost rollup, and privileged DPP production verification are independently tracked.

### Remaining

- Residual work is owned by `todos/scout-mastra-observability.md`, `todos/llm-cost-rollup.md`, `todos/dpp-goal-trace-post-deploy-verify.md`.
