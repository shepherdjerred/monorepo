...
export function toJson_BackupStorageLocationSpecObjectStorage(
  ...
  const result = {
    bucket: obj.bucket,
    caCert: obj.caCert,
    caCertRef: toJson_BackupStorageLocationSpecObjectStorageCaCertRef(
      obj.caCertRef,
    ),
    prefix: obj.prefix,
  };
 ...
 */
/* eslint-disable max-len, @stylistic/max-len, quote-props, @stylistic/quote-props */
export function toJson_BackupStorageLocationSpecObjectStorageCaCertRef(
  obj: BackupStorageLocationSpecObjectStorageCaCertRef | undefined,
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
