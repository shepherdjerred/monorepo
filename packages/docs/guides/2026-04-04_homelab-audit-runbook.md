...
| `matomo`                       | `matomo`                       | Matomo and MariaDB ready; the Tailscale admin endpoint and public Cloudflare endpoint respond after initialization; archive-worker failures, MariaDB errors, or stale reports are Red.      |
