...
- [Scout for League of Legends](https://github.com/shepherdjerred/monorepo/tree/main/packages/scout-for-lol)
...
- https://github.com/shepherdjerred/monorepo/tree/main/packages/scout-for-lol/ai_dev_log/competition/tasks
- https://github.com/shepherdjerred/monorepo/blob/main/packages/scout-for-lol/ai_dev_log/competition/DEVELOPMENT_CHEATSHEET.md
...
The repository later consolidated those client-specific copies into a
tool-neutral [AGENTS.md](https://github.com/shepherdjerred/monorepo/blob/main/AGENTS.md)
hierarchy.
...
const createRule = ESLintUtils.RuleCreator(
  (name) =>
    `https://github.com/shepherdjerred/monorepo/blob/main/packages/homelab/eslint-rules/${name}.ts`,
);
...
- https://github.com/shepherdjerred/monorepo/blob/main/packages/scout-for-lol/eslint.config.ts
- https://github.com/shepherdjerred/monorepo/tree/main/packages/scout-for-lol/eslint-rules
