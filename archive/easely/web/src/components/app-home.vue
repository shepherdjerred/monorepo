  ...
  <div>
          ...
          <div class="columns">
            ...
            <div class="column is-one-third">
              ...
              <h6 class="subtitle is-6">
                You have {{ upcomingAssignments.length }}
                {{
    ...
    <template v-else>
      <section class="hero is-primary is-medium">
        <div class="hero-body">
          <div class="container">
            <h1 class="title">Welcome to Easely</h1>
            <h2 class="subtitle">A better interface for EASEL</h2>
            <h2 class="subtitle">
              Please
              <router-link :to="{ name: 'Login' }" class="card-link"
                >Login</router-link
              >
              or
...
export default {
  ...
  computed: {
    ...
    upcomingAssignments: function () {
      let assignments = Helpers.sortAssignmentArrayByDate(
        Helpers.objectToArray(this.assignments),
      );
