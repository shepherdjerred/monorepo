...
- `../todos/bun-isolated-linker-eexist.md` —
...
Superseded by the Bun workspace and static Buildkite replatform. Dagger,
`scripts/setup.ts`, and the proposed canary/isolation mechanism no longer exist;
independent surviving work such as the Temporal smoke script shipped elsewhere.

## Comment Log

- 2026-07-27 — Board audit verified PRs #1516/#1517 removed the plan's core
  implementation surfaces. Closed as technology-era history rather than
  translating speculative Dagger work into the current pipeline.
