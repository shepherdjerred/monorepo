import { z } from "zod";
import { DivisionSchema, divisionToString } from "#src/model/division.ts";
import { TierSchema, type Tier } from "#src/model/tier.ts";
import { rankToLeaguePoints, tierToOrdinal } from "#src/model/league-points.ts";
