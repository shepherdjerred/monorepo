...
## [1.7.1](https://github.com/shepherdjerred/monorepo/compare/webring-v1.7.0...webring-v1.7.1) (2026-06-07)

No library behavior changes. The shipped code is identical to 1.7.0; this release exists only because release-please picked up a repo-level CI fix ([c0d3ff1](https://github.com/shepherdjerred/monorepo/commit/c0d3ff1eedfb305816f9770dcf5f99ee749ea596)) that does not touch this package.
