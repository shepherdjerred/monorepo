...
This does require a small amount of manual bootstrapping, which I describe in my [repository README](https://github.com/shepherdjerred/monorepo/blob/main/packages/homelab/README.md). Whenever I setup a new cluster/node, I need to:
