...
| `0006-player-elevation-observation.patch` | `src/wasm_observation.c`                                     | Advances the observation ABI to version 5 and exports the player object's current elevation in the former redundant object-active byte. This preserves the packed byte size while allowing exit navigation to distinguish bridge and overpass levels using Emerald's authoritative player state.                                                                                                                                                                                                                                                                                                                                                                                  |
