...
} from "@shepherdjerred/scout-data";
import { fromError } from "zod-validation-error";
import { match, P } from "ts-pattern";
import { prisma } from "@shepherdjerred/scout-backend/database/index.ts";
import { canCreateCompetition } from "@shepherdjerred/scout-backend/database/competition/permissions.ts";
import { type CreateCompetitionInput, createCompetition } from "@shepherdjerred/scout-backend/database/competition/queries.ts";
import { recordCreation } from "@shepherdjerred/scout-backend/database/competition/rate-limit.ts";
import { validateOwnerLimit, validateServerLimit } from "@shepherdjerred/scout-backend/database/competition/validation.ts";
import { getChampionId } from "@shepherdjerred/scout-backend/utils/champion.ts";
import { addParticipant } from "@shepherdjerred/scout-backend/database/competition/participants.ts";
...
import {
  ...
  getStatusEmoji,
  formatDateInfo,
} from "@shepherdjerred/scout-backend/discord/commands/competition/helpers.ts";
import {
  replyWithErrorFromException,
  replyWithError,
  replyWithSuccess,
} from "@shepherdjerred/scout-backend/discord/commands/competition/utils/replies.ts";
import {
  CommonArgsSchema,
...
} from "@shepherdjerred/scout-backend/discord/commands/competition/schemas.ts";
