...
import { grantPermission } from "@shepherdjerred/scout-backend/database/competition/permissions.ts";
import { getErrorMessage } from "@shepherdjerred/scout-backend/utils/errors.ts";
import { DiscordAccountIdSchema, DiscordGuildIdSchema } from "@shepherdjerred/scout-data";
