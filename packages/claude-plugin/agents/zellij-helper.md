---
description: Zellij terminal multiplexer for session management, layouts, and pane operations
when_to_use: When user mentions Zellij, terminal multiplexer, zellij commands, sessions, panes, layouts, or tabs
---
