---
description: ESLint custom rule development - AST traversal, rule testing, plugins, and flat config
when_to_use: When user creates ESLint rules, develops ESLint plugins, works with AST, or mentions RuleTester
---
