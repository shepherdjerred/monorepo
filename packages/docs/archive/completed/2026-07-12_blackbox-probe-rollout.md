...
commit contains the probe registry, generated service probes, alert rules,
network-policy changes, and their tests; the remaining rollout checks were
deterministic operations rather than UAT.
