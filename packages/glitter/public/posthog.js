(function () {
  // Official PostHog queueing snippet; calls made before array.js loads are preserved.
  !(function (t, e) {
    var o, n, p, r;
    e.__SV ||
      ((window.posthog = e),
  ...
  window.posthog.init("phc_uHgQEjvzAfgawsBscWRWKdynJ2bFtpPAECMEwoLWSSXh", {
    ...
    loaded: function (posthog) {
      posthog.register({
        site_key: "glitter-boys-ppl",
        site_hostname: "ppl.glitter-boys.com",
      });
    },
  });
})();
