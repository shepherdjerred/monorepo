class EJS_GameManager {
  constructor(Module, EJS) {
    ...
    this.functions = {
      ...
      setVideoRoation: this.Module.cwrap("set_video_rotation", "null", [
        "number",
      ]),
    };
  ...
  getRetroArchCfg() {
    ...
    if (this.EJS.retroarchOpts && Array.isArray(this.EJS.retroarchOpts)) {
      this.EJS.retroarchOpts.forEach((option) => {
        ...
        const value =
          option.isString === false ? selected : '"' + selected + '"';
  ...
  loadPpssppAssets() {
    return new Promise((resolve) => {
      this.EJS.downloadFile("cores/ppsspp-assets.zip", null, false, {
