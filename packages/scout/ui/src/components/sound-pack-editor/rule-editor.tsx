...
import type { SoundRule, SoundEntry, SoundSource } from "@shepherdjerred/scout-data";
import type { Champion, CacheStatus } from "@shepherdjerred/scout-ui/types/adapter.ts";
