...
// Branded fixture helpers: money and identity values in these fixtures carry
      ...
      bets: [
        {
          ...
          won: true,
          refunded: false,
          subjectPuuid: puuid("winner-puuid"),
        },
        {
          betId: 2,
          bucksAccountId: 2,
          ...
          matchedStake: amount(10),
          unmatchedStake: amount(0),
          grossPayout: amount(0),
          houseCut: amount(0),
          payout: amount(0),
          winnings: amount(0),
          won: false,
          refunded: false,
          subjectPuuid: puuid("loser-puuid"),
        },
      ],
    };
      ...
      bets: [
        {
          ...
          isHouse: false,
          predictedTeamId: 100,
          submittedStake: stake(14),
          matchedStake: amount(10),
          unmatchedStake: amount(4),
          grossPayout: amount(10),
          houseCut: amount(0),
          payout: amount(10),
          winnings: amount(0),
          won: false,
      ...
      unmatchedPositions: [
        {
          ...
          teamId: 100,
          submittedStake: stake(5),
          matchedStake: amount(0),
          unmatchedStake: amount(5),
        },
      ],
    });
      ...
      bets: [
        {
          ...
          isHouse: false,
          predictedTeamId: 100,
          submittedStake: stake(1),
          matchedStake: amount(1),
          unmatchedStake: amount(0),
          grossPayout: amount(2),
          houseCut: amount(0),
          payout: amount(2),
          winnings: amount(1),
          won: true,
      ...
      bets: [
        {
          ...
          isHouse: false,
          predictedTeamId: 100,
          submittedStake: stake(25),
          matchedStake: amount(25),
          unmatchedStake: amount(0),
          grossPayout: amount(50),
          houseCut: amount(10),
          payout: amount(40),
          winnings: amount(15),
          won: true,
  ...
  test("fits a full settlement into one bounded embed", () => {
    const summary: SettlementSummary = {
      ...
      bets: Array.from({ length: 16 }, (_, index) => ({
        ...
        won: true,
        refunded: false,
        subjectPuuid: puuid(`winner-puuid-${index.toString()}`),
      })),
    };
    const outcomeInput = {
      summary,
          ...
          positions: [
            {
              ...
              discordId: bucksTestDiscordId(1),
              teamId: 100,
              submittedStake: stake(9),
              matchedStake: amount(0),
              unmatchedStake: amount(9),
            },
          ],
        },
      ],
