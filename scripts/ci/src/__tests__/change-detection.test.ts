...
describe("isAutoGeneratedCommit", () => {
  ...
  it("returns true when message body has Auto-Generated trailer", () => {
    ...
    expect(_isAutoGeneratedCommit()).toBe(true);
  });

  it("returns true for trailer-only message", () => {
    process.env["BUILDKITE_MESSAGE"] = "Auto-Generated: ci-bot";
    expect(_isAutoGeneratedCommit()).toBe(true);
  });

  it("returns false for ordinary feature commit", () => {
    process.env["BUILDKITE_MESSAGE"] = "feat: add new feature";
    expect(_isAutoGeneratedCommit()).toBe(false);
  });
  ...
  it("does not match a trailer mentioned mid-line", () => {
    process.env["BUILDKITE_MESSAGE"] =
      "chore: discussing Auto-Generated: in the body";
    expect(_isAutoGeneratedCommit()).toBe(false);
  });
});
