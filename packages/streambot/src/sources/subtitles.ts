 ...
 * canonicalized exactly once here and never re-derived, so a later pinned download
 * (`ytdlpSubtitleArgs([candidate.lang], candidate.autoGenerated, ...)`) uses the byte-identical
