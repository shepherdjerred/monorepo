...
export function createCrudActionCreators(resource, endpoint, actionTypes) {
  ...
  for (let action in actionTypes) {
    actionTypesAsRsaaArrays[action] = actionTypesToRsaaArray(
      actionTypes[action],
    );
  }
  return {
    create: createCreateActionCreator(endpoint, actionTypesAsRsaaArrays.create),
    fetchList: createFetchListActionCreator(
      endpoint,
      actionTypesAsRsaaArrays.fetchList,
    ),
    fetchDetails: createFetchDetailsActionCreator(
      endpoint,
      actionTypesAsRsaaArrays.fetchDetails,
    ),
