...
- [ ] Mirror the `diataxis` skill to `~/.agents/skills/` — happens when this
      ...
      workspace.
- [ ] Phase 2 — autogenerate sidebar, directories, redirects, section test.
- [ ] Phase 3 — seven reference pages.
- [ ] Phase 4 — eleven how-to guides.
- [ ] Phase 5 — seventeen explanation pages.
- [ ] Phase 6 — two tutorials, home page, cross-links, gap fills.
- [ ] Verify no page still contains workflow/plan residue.
- [ ] Verify every old route redirects.
