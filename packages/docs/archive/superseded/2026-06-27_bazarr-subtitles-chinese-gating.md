...
This mixed, unapproved plan combined repository configuration, privileged live
configuration, paid accounts, and an optional product decision. It is replaced
by:

- `packages/docs/todos/bazarr-whisper-model-configuration.md`
- `packages/docs/todos/bazarr-chinese-provider-gating.md`
- `packages/docs/todos/bazarr-lingarr-decision.md`

## Comment Log

- 2026-07-27 — Board audit verified Whisper model settings remain absent and
  most other steps require operator access. Closed the monolith and split its
  independent outcomes with appropriate verification/disposition metadata.
