...
This is a half-baked post I decided to publish because it was clear I wasn't ever going to finish it. You can find the source code of this project on [GitHub](https://github.com/shepherdjerred/monorepo/tree/main/packages/discord-plays-pokemon).
