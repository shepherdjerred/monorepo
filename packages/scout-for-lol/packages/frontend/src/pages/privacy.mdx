...
- Basic analytics events through our privacy-focused analytics provider

This website measurement is separate from the Discord bot data described above.
It does not tell us whether a bot installation was completed, which server added
Scout, or which Discord commands were used after installation. We never sell your
