...
import type { RawChallenges, RawParticipant, Player, RawMatch } from "@shepherdjerred/scout-data";
import { ArenaMatchSchema, ArenaTeamSchema, LeaguePuuidSchema } from "@shepherdjerred/scout-data";
import { participantToArenaChampion } from "@shepherdjerred/scout-backend/league/model/champion.ts";
import { toArenaMatch, toArenaSubteams } from "@shepherdjerred/scout-backend/league/model/match.ts";
