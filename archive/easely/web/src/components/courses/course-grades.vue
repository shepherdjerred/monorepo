    ...
    <div class="columns is-multiline">
      <div class="column">
        ...
        <h6 class="is-6 subtitle">
          {{ course.userCourseGrade.homeworkWeight }}% of grade
        </h6>
      ...
      <div class="column">
        ...
        <h6 class="is-6 subtitle">
          {{ course.userCourseGrade.projectWeight }}% of grade
        </h6>
      ...
      <div class="column">
        ...
        <h6 class="is-6 subtitle">
          {{ course.userCourseGrade.examWeight }}% of grade
        </h6>
      ...
      <div class="column is-full is-centered">
        <h4 class="title is-4">
          Overall grade: {{ course.userCourseGrade.classAverage }}%
        </h4>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...
    assignmentsWithGrade: function () {
      ...
      Helpers.objectToArray(this.courseAssignments).forEach(
        function (assignment) {
