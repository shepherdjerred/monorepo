 ...
 *
 * Usage:
 *   bun packages/homelab/scripts/argocd/argocd.ts sync-managed <app> [--revision <v>]
 *       [--prune] [--terminate-after-applied]
 *       [--request-id <uuid>] [--timeout <s>] [--dry-run]
 *   bun packages/homelab/scripts/argocd/argocd.ts release-root apps <expected.json> \
 *       --revision <v> --request-id <uuid> [--timeout <s>] [--dry-run]
 *   bun packages/homelab/scripts/argocd/argocd.ts delete-application <app> \
 *       --project <project> [--timeout <s>] [--dry-run]
 *   bun packages/homelab/scripts/argocd/argocd.ts health-wait <app> [--timeout <s>] [--dry-run]
 *   bun packages/homelab/scripts/argocd/argocd.ts tree-health-wait <app> [--timeout <s>] [--dry-run]
 *   bun packages/homelab/scripts/argocd/argocd.ts suspend-auto-sync <root-app> \
 *       [--revision <v>] [--timeout <s>] [--dry-run]
 *   bun packages/homelab/scripts/argocd/argocd.ts verify-auto-sync <root-app> \
 *       --revision <v> [--dry-run]
 *   bun packages/homelab/scripts/argocd/argocd.ts wait-deletion <app> \
...
function usage(): never {
  console.error(
    "Usage:\n" +
      "  bun packages/homelab/scripts/argocd/argocd.ts sync-managed <app> " +
      ...
      "  bun packages/homelab/scripts/argocd/argocd.ts delete-application <app> " +
      "--project <project> [--timeout <s>] [--dry-run]\n" +
      "  bun packages/homelab/scripts/argocd/argocd.ts health-wait <app> " +
      "[--timeout <s>] [--dry-run]\n" +
      "  bun packages/homelab/scripts/argocd/argocd.ts tree-health-wait <app> " +
      "[--timeout <s>] [--dry-run]\n" +
      "  bun packages/homelab/scripts/argocd/argocd.ts suspend-auto-sync <root-app> " +
      "[--revision <v>] [--timeout <s>] [--dry-run]\n" +
      "  bun packages/homelab/scripts/argocd/argocd.ts verify-auto-sync <root-app> " +
