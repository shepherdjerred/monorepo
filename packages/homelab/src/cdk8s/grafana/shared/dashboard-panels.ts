/**
 * Shared Grafana panel builders.
 *
 * Lived under the Buildkite dashboard directory until that stack was removed,
 * but nothing about them is CI-provider specific -- the buildkitd dashboard
 * has always used them too.
 */
