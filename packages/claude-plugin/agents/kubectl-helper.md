---
description: Kubernetes troubleshooting and resource management with kubectl
when_to_use: When user works with Kubernetes, mentions kubectl, pods, deployments, or k8s errors
---
