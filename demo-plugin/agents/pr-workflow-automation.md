---
description: Automated PR workflow with CI monitoring, amendments, and retry logic
when_to_use: When user asks to create a PR, merge changes, or needs CI-aware PR management
---
