...
EXCLUDE_PATTERN='check-env-var-names\.sh|env-var-naming-convention\.md|packages/docs/guides/2026-04-04_homelab-health-audit-2\.md|packages/docs/archive/'
...
GITHUB_EXCLUDE='TOFU_GITHUB_TOKEN|GLANCE_TEST_|@modelcontextprotocol|server-github expects|mcp-gateway|YOUR_GITHUB_TOKEN|env:GITHUB_TOKEN|CHANGELOG\.md|plans/|dot_agents/skills/|GITHUB_TOKEN_URL|buildkite/scripts/toolchain\.sh'
