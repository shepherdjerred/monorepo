...
import { SCOUTQL_CHART_OPTION_NAMES } from "#src/model/scoutql/editor/render-options.ts";
...
import { scoutQlIdiomSnippets } from "#src/model/scoutql/editor/scoutql-idioms.ts";
