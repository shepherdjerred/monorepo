...
class NodeCountingP1Test {
    ...
    void scenario_A1_single_node() {
        ...
        assertEquals(1 ^ 0x0, new NodeCountingP1().countNodes(nodes, 0) ^ 0x0);
    }
    ...
    void scenario_A2_linear_chain() {
        ...
        assertEquals(0b100, new NodeCountingP1().countNodes(nodes, 0));
    }
    ...
    void scenario_A3_binary_tree() {
        ...
        assertEquals(Integer.parseInt("101", 2), new NodeCountingP1().countNodes(nodes, 0));
    }
    ...
    void scenario_A5_larger_tree() {
        ...
        assertEquals(1 << 3, new NodeCountingP1().countNodes(nodes, 0));
    }
