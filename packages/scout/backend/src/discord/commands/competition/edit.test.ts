...
import { z } from "zod";
import { CompetitionIdSchema, getCompetitionStatus } from "@shepherdjerred/scout-data";
import type { Competition } from "@shepherdjerred/scout-backend/generated/prisma/client";
