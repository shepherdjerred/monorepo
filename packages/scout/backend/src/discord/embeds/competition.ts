import type { CompetitionCriteria, CompetitionQueueType, CompetitionWithCriteria, Rank } from "@shepherdjerred/scout-data";
import { getCompetitionStatus, competitionQueueTypeToString, rankToString, RankSchema } from "@shepherdjerred/scout-data";
import { EmbedBuilder, Colors } from "discord.js";
import { match } from "ts-pattern";
import { z } from "zod";
import { getChampionName } from "twisted/dist/constants/champions.js";
import type { RankedLeaderboardEntry } from "@shepherdjerred/scout-backend/league/competition/leaderboard.ts";
