...
export const DEFAULT_ARCHITECTURES = "aarch64,x86_64";
export const DEFAULT_SDK_VERSION = "15.0";
export const DEFAULT_KERNEL_VERSION = "24";
export const DEFAULT_TARGET_SDK_VERSION = "11.0.0";
...
/**
 * Options for building cctools for a specific architecture
 */
...
/**
 * Options for building wrapper scripts (clang or gcc)
 */
export type BuildWrappersOptions = {
  container: Container;
  sdkVersion: string;
  kernelVersion: string;
  targetSdkVersion: string;
