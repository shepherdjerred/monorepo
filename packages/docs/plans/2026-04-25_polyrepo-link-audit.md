...
Many packages in this monorepo (`github.com/shepherdjerred/monorepo`) used to live as standalone polyrepos. After consolidating into the monorepo, hundreds of stale polyrepo links remain in package metadata, READMEs, blog posts, in-app UI, ESLint rule URLs, install scripts, Discord bot help text, source comments, and config files.
...
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| legacy package repo root URL                                                      | `https://github.com/shepherdjerred/monorepo/tree/main/packages/<pkg>`                                     |
| legacy package repo clone URL                                                     | `https://github.com/shepherdjerred/monorepo.git`                                                          |
| legacy package repo `git+https` clone URL                                         | `git+https://github.com/shepherdjerred/monorepo.git`                                                      |
| legacy package repo issues URL                                                    | `https://github.com/shepherdjerred/monorepo/issues`                                                       |
| legacy package repo issue URL with number                                         | `https://github.com/shepherdjerred/monorepo/issues/<n>` if `n` exists in monorepo, else `monorepo/issues` |
| legacy package repo blob URL                                                      | `https://github.com/shepherdjerred/monorepo/blob/main/packages/<pkg>/<path>`                              |
| legacy package repo commit URL                                                    | rewrite host; verify SHA resolves in monorepo                                                             |
| legacy package repo releases URL                                                  | `https://github.com/shepherdjerred/monorepo/releases/...` (release-please uses tag prefixes per package)  |
| `https://github.com/shepherdjerred/monorepo/tree/main/packages/eslint-config/...` | `https://github.com/shepherdjerred/monorepo/tree/main/packages/eslint-config/...`                         |
...
All in `packages/eslint-config/src/rules/`. Pattern: `https://github.com/shepherdjerred/monorepo/tree/main/packages/eslint-config/src/rules/${name}.ts` → `https://github.com/shepherdjerred/monorepo/tree/main/packages/eslint-config/src/rules/${name}.ts`
...
1. **Cooklang for Obsidian: external plugin repo was treated as a hard requirement at the time.** `.dagger/src/release.ts:567,573`, `packages/cooklang-for-obsidian/README.md`, and `packages/cooklang-rich-preview/` all referenced the external plugin repo.
