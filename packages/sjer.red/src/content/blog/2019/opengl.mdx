...
<figure>
  ![CPU architecture](./opengl/img/cpu.png) ![GPU
  architecture](./opengl/img/gpu.png)
  <figcaption>
...
<figure>
  ...
  <figcaption>
    Figure 5, a projection matrix where a is the aspect ratio, `fov` is the
    field of view, `z_f` is z-far, and `z_n` is z-near (hernandez2019).
  </figcaption>
</figure>
...
<figure>
  <div class="bg-white">
    ![Visualization of the pipeline](./opengl/img/pipeline-visualized.png)
  </div>
  <figcaption>
