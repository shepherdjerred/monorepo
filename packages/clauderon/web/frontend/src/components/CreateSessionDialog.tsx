        ...
        return [
          {
            value: {
              ...
              content: "Sonnet4_5" as ClaudeModel,
            },
          ...
          },
          {
            value: {
              type: "Claude" as const,
              content: "Opus4_5" as ClaudeModel,
            },
          ...
          },
          {
            value: {
              type: "Claude" as const,
              content: "Haiku4_5" as ClaudeModel,
            },
          ...
          },
          {
            value: {
              type: "Claude" as const,
              content: "Opus4_1" as ClaudeModel,
            },
          ...
          },
          {
            value: {
              type: "Claude" as const,
              content: "Sonnet4" as ClaudeModel,
            },
            label: "Sonnet 4",
          },
        ];
        ...
        return [
          {
            value: {
              type: "Codex" as const,
              content: "Gpt5_2Codex" as CodexModel,
            },
          ...
          },
          {
            value: {
              type: "Codex" as const,
              content: "Gpt5_2Instant" as CodexModel,
            },
          ...
          },
          {
            value: {
              type: "Codex" as const,
              content: "Gpt5_2Pro" as CodexModel,
            },
          ...
          },
          {
            value: {
              type: "Codex" as const,
              content: "Gpt5_1Instant" as CodexModel,
            },
        ...
        return [
          {
            value: {
              ...
              content: "Gemini3Pro" as GeminiModel,
            },
          ...
          },
          {
            value: {
              type: "Gemini" as const,
              content: "Gemini3Flash" as GeminiModel,
            },
          ...
          },
          {
            value: {
              type: "Gemini" as const,
              content: "Gemini2_5Pro" as GeminiModel,
            },
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <RepositoryPathSelector
                      ...
                      onChange={(path) => {
                        handleRepoPathChange(repo.id, path);
                      }}
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        handleBaseBranchChange(repo.id, e.target.value);
                      }}
                    ...
                    <p className="text-xs text-muted-foreground">
                      Branch to clone from for clone-based backends (Sprites,
                      Kubernetes). Leave empty for default branch.
                    </p>
                  </div>
                  ...
                  {multiRepoEnabled && (
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          handleMountNameChange(repo.id, e.target.value);
                        }}
            ...
            {formData.agent in AGENT_CAPABILITIES && (
              ...
              >
                ...
                <ul className="space-y-1.5 pl-1">
                  {AGENT_CAPABILITIES[formData.agent].features.map(
                    (feature, idx) => (
                  ...
                  <div className="space-y-2">
                    ...
                    {loadingStorageClasses ? (
                      ...
                      <>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Storage class for persistent volume claims (PVCs).
                          Affects cache and workspace volumes.
                        </p>
                      </>
                    ) : (
                      <div className="text-sm text-muted-foreground">
                        No storage classes available. Check cluster
                        configuration.
                      </div>
                    )}
                  </div>
