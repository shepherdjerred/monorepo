...
| ---------------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Verification window close after the matched fragment | per-fragment tail + 150 ms margin (1250 ms fallback without timestamps) | `packages/streambot/src/voice/constants.ts`                                                                                                                                                      |
...
| Backoff after an OpenAI quota refusal                | 1 h                                                                     | `packages/streambot/src/voice/cloud-verification-rate-limiter.ts`                                                                                                                                |
