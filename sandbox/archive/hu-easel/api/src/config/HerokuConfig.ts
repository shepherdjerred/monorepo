...
export default class HerokuConfig implements Config {
  ...
  isRegistrationEnabled = HerokuConfig.getPrefixedEnvironmentVariable(
    "IS_REGISTRATION_ENABLED",
  );
  isAuthenticationEnabled = HerokuConfig.getPrefixedEnvironmentVariable(
    "IS_AUTHENTICATION_ENABLED",
  );
  isAuthorizationEnabled = HerokuConfig.getPrefixedEnvironmentVariable(
    "IS_AUTHORIZATION_ENABLED",
  );
  isDevelopmentMode = HerokuConfig.getPrefixedEnvironmentVariable(
    "IS_DEVELOPMENT_MODE",
  );
  shouldForceModelSync = HerokuConfig.getPrefixedEnvironmentVariable(
