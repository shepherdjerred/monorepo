...
Superseded. Dagger and the dynamic CI generator were removed; the surviving
secret blast-radius work is tracked in
`packages/docs/plans/2026-06-28_ci-secret-blast-radius-scoping.md` and finding
F-02 of the 2026-07-19 infrastructure security audit.

## Comment Log

- 2026-07-27 — Board audit verified `.dagger/` and `scripts/ci/` are absent and
  current CI is static `.buildkite/pipeline.yml`. Closed without carrying
  obsolete implementation tasks forward.
