...
- PR #1694 merged the Luna model support, spatial deltas, structured logs, and full tool-body tracing.

### Remaining

- Residual work is owned by `todos/pokemon-goal-luna-production-activation.md`.
