---
description: Bun test runner - Jest-compatible testing with mocks, snapshots, coverage, and DOM testing patterns
when_to_use: When user writes tests with Bun, uses bun:test, creates mocks, runs test coverage, or mentions describe/it/expect patterns
---
