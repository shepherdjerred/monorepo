...
# Email security
resource "cloudflare_dns_record" "better_skill_capped_com_spf" {
  zone_id = cloudflare_zone.better_skill_capped_com.id
  ttl     = 1
  name    = "better-skill-capped.com"
  type    = "TXT"
...
resource "cloudflare_dns_record" "better_skill_capped_com_dmarc" {
  zone_id = cloudflare_zone.better_skill_capped_com.id
  ttl     = 1
  name    = "_dmarc"
  type    = "TXT"
...
resource "cloudflare_dns_record" "better_skill_capped_com_dkim_wildcard" {
  zone_id = cloudflare_zone.better_skill_capped_com.id
  ttl     = 1
  name    = "*._domainkey"
  type    = "TXT"
