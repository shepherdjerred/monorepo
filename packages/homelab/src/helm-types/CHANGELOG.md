...
## [1.3.1](https://github.com/shepherdjerred/monorepo/compare/helm-types-v1.3.0...helm-types-v1.3.1) (2026-06-08)

No library behavior changes. The shipped code is identical to 1.3.0; this release exists only because of a CI-pipeline fix in the monorepo root ([c0d3ff1](https://github.com/shepherdjerred/monorepo/commit/c0d3ff1eedfb305816f9770dcf5f99ee749ea596)) that release-please picked up.
