...
use multiplexer::backends::{CreateOptions, DockerBackend, DockerProxyConfig, ExecutionBackend};
use multiplexer::proxy::{Credentials, ProxyCa};
...
async fn test_claude_print_mode_e2e() {
    use multiplexer::proxy::{AuditLogger, HttpAuthProxy};
    use std::sync::Arc;
