...
describe("ClauderonClient - constructor", () => {
...
describe("ClauderonClient - listSessions and getSession", () => {
...
describe("ClauderonClient - createSession and session actions", () => {
...
describe("ClauderonClient - start, wake, recreate, cleanup", () => {
