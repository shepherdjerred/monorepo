...
import { z } from "zod";
import type { Rank, Tier, Division } from "@shepherdjerred/scout-data";
import { wasPromoted, wasDemoted, divisionToString, TierSchema, DivisionSchema } from "@shepherdjerred/scout-data";
