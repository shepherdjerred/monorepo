 ...
 *
 * Usage:
 *   GH_TOKEN=$(gh auth token) bun scripts/review/review-analytics.ts rounds --last 50
 *   GH_TOKEN=$(gh auth token) bun scripts/review/review-analytics.ts requests --last 50
 *   GH_TOKEN=$(gh auth token) bun scripts/review/review-analytics.ts blame --pr 2301
 *   GH_TOKEN=$(gh auth token) bun scripts/review/review-analytics.ts rounds --last 20 --json
 */
