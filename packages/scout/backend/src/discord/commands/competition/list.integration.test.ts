...
import { type DiscordAccountId, type DiscordChannelId, type DiscordGuildId } from "@shepherdjerred/scout-data";
import { createCompetition, getCompetitionsByServer } from "@shepherdjerred/scout-backend/database/competition/queries.ts";
