const nativeInfrastructurePaths = [
  ...
  "ci/scripts/macos/macos-native-dispatch-watch.ts",
  "ci/scripts/macos/macos-native-dispatch-watch.test.ts",
  ...
  "ci/scripts/validation/validate-pipeline.ts",
  "ci/scripts/validation/validate-pipeline-lib.ts",
  "ci/scripts/validation/validate-pipeline-lib.test.ts",
  ".mise.toml",
  ".xcode-version",
