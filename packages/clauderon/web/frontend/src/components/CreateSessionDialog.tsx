...
import type { CreateSessionRequest, BackendType, AgentType, AccessMode, CreateRepositoryInput } from "@clauderon/client";
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-8 z-50">
        <div className="max-w-3xl w-full flex flex-col border-4 border-primary max-h-[90vh]" style={{
