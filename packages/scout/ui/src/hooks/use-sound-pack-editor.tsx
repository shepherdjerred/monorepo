...
import type { SoundPack, SoundRule, SoundPool, SoundEntry, EventType } from "@shepherdjerred/scout-data";
import { createEmptySoundPack, createEmptySoundPool, createEmptyRule, generateId } from "@shepherdjerred/scout-data";
import type { SoundPackAdapter, Champion, LocalPlayer } from "@shepherdjerred/scout-ui/types/adapter.ts";
