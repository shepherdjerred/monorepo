...
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Accessibility                      | BetterMouse, Middle, Swish, Rectangle Pro, and CleanShot X when requested                                  | Exercise mouse remapping, middle click, window gestures, window throw, and CleanShot annotation controls |
