...
export interface DsaDevicePluginSpec {
   ...
   *
   * @schema DsaDevicePluginSpec#driver
   */
  readonly driver?: DsaDevicePluginSpecDriver;
 ...
 * Driver name used for the DSA devices.
 *
 * @schema DsaDevicePluginSpecDriver
 */
export enum DsaDevicePluginSpecDriver {
  /** idxd */
  IDXD = "idxd",
  /** vfio-pci */
...
export interface GpuDevicePluginSpec {
   ...
   *
   * @schema GpuDevicePluginSpec#monitoringMode
   */
  readonly monitoringMode?: GpuDevicePluginSpecMonitoringMode;
 ...
 * split: per-driver resources (i915_monitoring, xe_monitoring).
 *
 * @schema GpuDevicePluginSpecMonitoringMode
 */
export enum GpuDevicePluginSpecMonitoringMode {
  /** split */
  SPLIT = "split",
  /** single */
  SINGLE = "single",
