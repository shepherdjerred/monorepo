import { getCompetitionStatus, type CachedLeaderboard, type CompetitionWithCriteria } from "@shepherdjerred/scout-data/index";
import { prisma } from "@shepherdjerred/scout-backend/database/index.ts";
import { getActiveCompetitions } from "@shepherdjerred/scout-backend/database/competition/queries.ts";
import {
  calculateLeaderboard,
  type RankedLeaderboardEntry,
} from "@shepherdjerred/scout-backend/league/competition/leaderboard.ts";
import { generateLeaderboardEmbed } from "@shepherdjerred/scout-backend/discord/embeds/competition.ts";
import { send as sendChannelMessage, ChannelSendError } from "@shepherdjerred/scout-backend/league/discord/channel.ts";
import { saveCachedLeaderboard } from "@shepherdjerred/scout-backend/storage/s3-leaderboard.ts";
import { createSnapshot, getSnapshot } from "@shepherdjerred/scout-backend/league/competition/snapshots.ts";
import { getParticipants } from "@shepherdjerred/scout-backend/database/competition/participants.ts";
import { EmbedBuilder } from "discord.js";
import { z } from "zod";
import * as Sentry from "@sentry/bun";
import { logNotification } from "@shepherdjerred/scout-backend/utils/notification-logger.ts";
