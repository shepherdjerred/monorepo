...
import configuration from "@shepherdjerred/scout-backend/configuration.ts";
import { debugCommand } from "@shepherdjerred/scout-backend/discord/commands/debug.ts";
import { competitionCommand } from "@shepherdjerred/scout-backend/discord/commands/competition/index.ts";
import { adminCommand } from "@shepherdjerred/scout-backend/discord/commands/admin/index.ts";
import { subscriptionCommand } from "@shepherdjerred/scout-backend/discord/commands/subscription/index.ts";
import { helpCommand } from "@shepherdjerred/scout-backend/discord/commands/help.ts";
