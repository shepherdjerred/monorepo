...
export function ManageServers() {
  ...
  return (
    <LoadingBlock values={{ guilds: guildsValue }}>
      {({ guilds }, meta) => (
        <>
          ...
          <div className="mx-auto max-w-5xl space-y-6 px-6 py-8 sm:px-8 sm:py-12">
            <div className="space-y-2">
              ...
              <p className="max-w-2xl text-scout-subtle">
                Configure Scout for servers you can manage, or begin setup for a
                new Discord server.
              </p>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Sign in to Discord&apos;s installation flow, choose a server,
                  then finish tracking your first player in Scout.
                </CardDescription>
              </CardHeader>
            ...
            <section className="space-y-4" aria-labelledby="manageable-servers">
              <div className="flex items-center gap-2">
                <Settings
                  className="h-5 w-5 text-scout-subtle"
                  aria-hidden="true"
                />
              ...
              {guilds.length === 0 ? (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      You can still set up Scout for a server where Discord
                      allows you to install apps.
                    </CardDescription>
                  </CardHeader>
                </Card>
              ) : (
