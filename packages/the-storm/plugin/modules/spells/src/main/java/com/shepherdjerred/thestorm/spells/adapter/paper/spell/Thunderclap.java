...
/**
 * Thunderclap (V): the caster claps thunder; a shockwave hurts and throws back every creature they
 * can see around them that they may harm.
 */
                  ...
                  for (var victim : victims) {
                    ...
                    var blow =
                        Harm.Blow.none()
                            ...
                            .withVelocity(Magic.vector(push));
                    tools.harm().strike(caster, victim, blow);
                  }
