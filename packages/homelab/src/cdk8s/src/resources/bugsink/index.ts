...
export function createBugsinkDeployment(chart: Chart) {
  ...
  // - smtp-username: Postal SMTP credential username (create in Postal web UI)
  // - smtp-password: Postal SMTP credential password (create in Postal web UI)
  ...
  deployment.addContainer(
    withCommonProps({
      ...
      envVariables: {
        ...
        // Add smtp-username and smtp-password to bugsink-credentials in 1Password
