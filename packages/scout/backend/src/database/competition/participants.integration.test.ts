...
import {
  ...
  getParticipants,
  removeParticipant,
} from "@shepherdjerred/scout-backend/database/competition/participants.ts";
...
import type { CompetitionId, DiscordAccountId, PlayerId } from "@shepherdjerred/scout-data";
