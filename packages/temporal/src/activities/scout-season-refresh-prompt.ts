...
export function buildSeasonRefreshPrompt(
  ...
  return [
    ...
    "   no drift was found. For every current, upcoming, or changed start/end",
    "   date, cite both a Riot URL and a League wiki URL whose fetched page",
    "   visibly states that exact calendar date. The caller fetches the pages",
    "   and verifies the date text; a reachable index or homepage is not",
    "   evidence and makes the run inconclusive.",
    "8. Your final response MUST end with one of these sentinel lines exactly:",
