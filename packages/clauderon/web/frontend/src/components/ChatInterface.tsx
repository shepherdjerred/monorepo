          ...
          const containerPath =
            idx === -1
              ...
              : "/workspace/.clauderon/uploads/" +
                response.path.slice(idx + prefix.length);
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-8 z-50">
        <div
          className="max-w-5xl w-full h-[85vh] flex flex-col border-4 border-primary"
          style={{
        ...
        >
          ...
          {/* Input */}
          <div
            className="p-4 border-t-4 border-primary"
          ...
          >
            ...
            >
              Reading from Claude Code session history. For full terminal
              control, switch to console view.
            </p>
          </div>
        </div>
      </div>
