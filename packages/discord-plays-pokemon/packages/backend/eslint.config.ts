...
const config = [
  ...recommended({
    ...
    projectService: {
      allowDefaultProject: [
        ...
        "src/goal/codex/codex-command.test.ts",
        "src/goal/memory/catch-evidence.test.ts",
        ...
        "src/goal/codex/codex-trace.test.ts",
        "src/goal/discord-message.test.ts",
        "src/goal/e2e-goal.integration.test.ts",
        "src/goal/game/game-battle-control.test.ts",
        "src/goal/game/game-controller-interact.test.ts",
        "src/goal/game/game-controller.test.ts",
        "src/goal/game/game-state-summary.test.ts",
        "src/goal/goal-activity.test.ts",
        "src/goal/goal-manager.test.ts",
        "src/goal/schema-helpers.test.ts",
        "src/goal/control/semantic-control-routes.test.ts",
        "src/goal/control/goal-control-gate.test.ts",
        "src/goal/control/goal-input-lease.test.ts",
        "src/goal/memory/goal-memory.test.ts",
        "src/goal/memory/history-summary.test.ts",
        "src/goal/memory/knowledge.test.ts",
        "src/goal/control/pokemonctl-output.test.ts",
  ...
  },
  {
    ...
    // src/goal/benchmark/benchmark-worker-boot-readiness.ts, which holds the unit-tested
