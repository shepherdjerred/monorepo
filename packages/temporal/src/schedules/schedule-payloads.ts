...
export const HOMELAB_AUDIT_AGENT_TASK: AgentTaskInput = {
  ...
  prompt: [
    ...
    "Do not mutate Kubernetes, GitHub, Alerts, Grafana, Bugsink, Cloudflare, files, or git state.",
    ...
    "Check exactly these areas: firing Prometheus alerts, open Alerts occurrences, failed/stuck",
