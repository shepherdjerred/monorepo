      ...
      <div class="columns">
        <div class="column is-one-third is-offset-one-third">
          <div class="notification is-primary">
            Please
            <router-link :to="{ name: 'About' }" class="alert-link"
              >read about Easely</router-link
            >
            before registering
          </div>
          <div class="box loginMenu">
            ...
            <form v-on:submit.prevent="onSubmit">
              ...
              <p>
                We need your EASEL credentials to load your classes,
                assignments, and grades from the EASEL website. They are stored
                in plain text.
              </p>
...
export default {
  ...
  computed: {
    isEmailInvalid: function () {
      ...
      return (
        /(@)/.test(this.email) &&
        !/@harding.edu\s*$/.test(this.email.toLowerCase())
      );
    },
