...
const OTHER_OLD_ANSWER_ID = "44444444-4444-4444-8444-444444444444";
    ...
    expect(
      resolveExploreRunCompletion({
        run: {
          ...
          versionCountAtStart: 2,
        },
        outcome: "failed",
        finalMessageId: null,
        messages: [
          answer(OTHER_OLD_ANSWER_ID, [], [OLD_ANSWER_ID, OTHER_OLD_ANSWER_ID]),
        ],
      }),
  ...
  test("recognizes a persisted answer when completion raced reconnection", () => {
    expect(
      resolveExploreRunCompletion({
        ...
        outcome: "interrupted",
        finalMessageId: null,
        messages: [answer(NEW_ANSWER_ID, [], [OLD_ANSWER_ID, NEW_ANSWER_ID])],
      }),
