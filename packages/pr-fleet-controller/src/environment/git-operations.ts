...
import { isTelemetryCaptureError } from "#runtime/telemetry.ts";
import { parseHeadSha, splitRepo } from "#domain/evidence-parsers.ts";
import type {
  CommandRequest,
  CommandResult,
  FleetTelemetry,
} from "#domain/ports.ts";
import { recordProgressEvent } from "#runtime/progress-events.ts";
