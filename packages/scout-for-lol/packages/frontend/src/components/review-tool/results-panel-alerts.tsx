    ...
    <div className="mb-4 p-4 rounded-xl bg-scout-danger border border-scout-danger animate-fade-in">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="font-semibold text-scout-danger-ink mb-1">
            Cannot Generate Review
          </div>
          <div className="text-sm text-scout-danger-ink">{error}</div>
        </div>
        <button
          onClick={onDismiss}
          className="text-scout-danger-ink hover:text-scout-danger-ink"
        >
          <svg
            className="w-4 h-4"
            fill="none"
...
export function NoMatchInfoBox() {
  return (
    <div className="mb-4 p-4 rounded-xl bg-scout-warning border border-scout-warning text-sm text-scout-warning-ink flex items-center gap-3">
      <svg
        className="w-5 h-5 text-scout-warning-ink shrink-0"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
