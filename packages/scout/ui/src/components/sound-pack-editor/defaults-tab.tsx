...
import { EVENT_TYPES, EVENT_TYPE_LABELS, createEmptySoundPool, type EventType } from "@shepherdjerred/scout-data";
import { useSoundPackEditor } from "@shepherdjerred/scout-ui/hooks/use-sound-pack-editor.tsx";
