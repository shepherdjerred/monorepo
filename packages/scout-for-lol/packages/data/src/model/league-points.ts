...
import { z } from "zod";
import { numberOfDivisions } from "@scout-for-lol/data/model/division";
import type { Rank } from "@scout-for-lol/data/model/rank";
import type { Tier } from "@scout-for-lol/data/model/tier";
