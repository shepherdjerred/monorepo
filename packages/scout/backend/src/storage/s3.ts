import type { MatchId, RawMatch, RawTimeline } from "@shepherdjerred/scout-data/index.ts";
import { MatchIdSchema } from "@shepherdjerred/scout-data/index.ts";
import { saveToS3 } from "@shepherdjerred/scout-backend/storage/s3-helpers.ts";
