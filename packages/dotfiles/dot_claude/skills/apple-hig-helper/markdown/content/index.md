# Content | Apple Developer Documentation

**Source**: [https://developer.apple.com/design/human-interface-guidelines/content](https://developer.apple.com/design/human-interface-guidelines/content)

---

# Content

[![A stylized representation of a bar chart. The image is tinted red to subtly reflect the red in the original six-color Apple logo.]( "Image failed to load")
...
[![A stylized representation of a compass icon. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](https://docs-assets.developer.apple.com/published/2a6743c71b9e9fd37d76627f3c792f00/components-web-views-thumbnail%402x.png)
