...
impl SessionManager {
    ...
    pub async fn with_defaults(
        ...
        let kubernetes_exec: Arc<dyn ExecutionBackend> = Arc::clone(&kubernetes_backend) as _;
    ...
    /// Get a handle to the console manager.
    #[must_use]
    ...
    pub async fn refresh_session(&self, id_or_name: &str) -> anyhow::Result<()> {
        ...
        let _permit = self
            ...
            .acquire()
            .await
            .map_err(|_err| anyhow::anyhow!("System is shutting down"))?;
