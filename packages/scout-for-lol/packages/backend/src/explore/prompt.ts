...
export function dareExplorePromptSection(): string {
  return [
    ...
    "A dare plan is the authoritative meaning. Never invent raw SQL or a target identity; the tools freeze the plan, render canonical ScoutQL, and resolve approved target keys.",
