...
import { buildBbRulesEmbed as createBbRulesEmbed } from "#src/discord/commands/bb/bb-rules.ts";
import {
  replyBbNotifications,
  type BbNotificationCommandDependencies,
} from "#src/discord/commands/bb/bb-notifications.ts";
import {
  replyBbHistory,
  replyBbPrizes,
  replyBbRules,
} from "#src/discord/commands/bb/bb-overview.ts";
import {
  replyBbDare,
...
} from "#src/discord/commands/bb/bb-transfer.ts";
