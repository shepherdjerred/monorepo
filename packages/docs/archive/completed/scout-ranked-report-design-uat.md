...
# Accept the beta ranked-report banner and square designs

The high-resolution splash implementation shipped in PR #924. PR #1697 keeps
the two redesigns limited to beta and local development until the owner accepts
their visual result.
