 ...
 * the nine Activities of the V2 per-match core, which
 * `SCOUT_V2_ACTIVITY_QUEUE_CLASSES` assigns to this same queue so one worker
 * registration serves an open v1 execution and a V2 one alike.
 *
