...
describe("evaluateGate — skipped-review shortcut", () => {
  ...
  it("passes when Greptile skipped review because PR author is excluded and there are no blocking threads", () => {
    // Renovate bot PRs are in Greptile's excluded authors list; the gate must
...
describe("parseGreptileSkippedReview", () => {
  ...
  it('returns "excluded-author" for the exact Greptile excluded-author comment body (PR #1359)', () => {
    // Exact body Greptile posted on shepherdjerred/monorepo#1359 (Renovate bot):
    //   <!-- greptile-status -->
