      ...
      for (let value of [true, false]) {
        ...
        should(result).deepEqual(
          ast.Template({ line: 1, char: 1 }, undefined, [
            ast.Bloc(
              { line: 1, char: 1 },
              ast.Boolean({ line: 1, char: 3 }, value),
            ),
          ]),
        );
      }
      ...
      for (let value of [0, 1, 3.14, 0.834, 123e123, 321e-321]) {
        ...
        should(result).deepEqual(
          ast.Template({ line: 1, char: 1 }, undefined, [
            ast.Bloc(
              { line: 1, char: 1 },
              ast.Number({ line: 1, char: 3 }, value),
            ),
          ]),
        );
      }
      ...
      for (let value of [
        ...
        should(result).deepEqual(
          ast.Template({ line: 1, char: 1 }, undefined, [
            ast.Bloc(
              { line: 1, char: 1 },
              ast.String({ line: 1, char: 3 }, value),
            ),
          ]),
        );
      }
      ...
      for (let value of ["x", "abc123", "hello_there", "_GoOdBye_37"]) {
        ...
        should(result).deepEqual(
          ast.Template({ line: 1, char: 1 }, undefined, [
            ast.Bloc(
              { line: 1, char: 1 },
              ast.Identifier({ line: 1, char: 3 }, value),
            ),
          ]),
        );
      }
    ...
    it("should parse a bloc with an array construction", () => {
      ...
      should(result).deepEqual(
        ast.Template({ line: 1, char: 1 }, undefined, [
          ast.Bloc(
            { line: 1, char: 1 },
            ast.ArrayConstruction({ line: 1, char: 3 }, [
    ...
    it("should parse multiple blocs", () => {
      ...
      should(result).deepEqual(
        ast.Template({ line: 1, char: 1 }, undefined, [
          ...
          ast.Bloc(
            { line: 1, char: 8 },
            ast.String({ line: 1, char: 10 }, "Fred"),
          ),
          "!\n",
          "\nYou owe $",
          ast.Bloc(
            { line: 5, char: 10 },
            ast.Number({ line: 5, char: 12 }, 3.5e2),
          ),
          ".\n",
          ast.Bloc(
            { line: 6, char: 1 },
            ast.Identifier({ line: 7, char: 1 }, "done"),
          ),
        ]),
      );
    });
        ...
        should(result).deepEqual(
          ast.Template({ line: 1, char: 1 }, undefined, [
            ast.Bloc(
              { line: 1, char: 1 },
              ast.BinaryOperation(
                { line: 1, char: 11 + 2 * op.length },
                ast.BinaryOperation(
                  { line: 1, char: 8 + op.length },
                  ast.BinaryOperation(
                    { line: 1, char: 5 },
      ...
      should(result).deepEqual(
        ast.Template({ line: 1, char: 1 }, undefined, [
          ...
          ast.Bloc(
            ...
            ast.Template({ line: 1, char: 15 }, undefined, ["bad"]),
          ),
          " world",
        ]),
      );
          ...
          ast.Bloc(
            ...
            ast.Template({ line: 1, char: 9 }, undefined, [
              ast.Bloc(
                ...
                ast.Template({ line: 1, char: 17 }, undefined, ["hello"]),
              ),
            ]),
          ),
        ]),
      ...
      should(result).deepEqual(
        ast.Template({ line: 1, char: 1 }, undefined, [
              ...
              ast.Bloc(
                ...
                ast.Template({ line: 1, char: 20 }, undefined, [
                  ...
                  ast.Bloc(
                    ...
                    ast.Template({ line: 1, char: 33 }, undefined, ["ghi"]),
                  ),
                ]),
              ),
            ]),
          ...
          ast.Bloc(
            ...
            ast.Template({ line: 1, char: 56 }, undefined, ["mno"]),
          ),
        ]),
      );
    });
      ...
      should(result).deepEqual(
        ast.Template({ line: 1, char: 1 }, undefined, [
          ...
          ast.Bloc(
            ...
            ast.Template({ line: 4, char: 1 }, undefined, ["  def"]),
          ),
        ]),
      );
    });
      ...
      should(result).deepEqual(
        ast.Template({ line: 1, char: 1 }, undefined, [
          ast.Bloc(
            { line: 1, char: 1 },
            ast.Identifier({ line: 1, char: 4 }, "foo"),
            ast.Template({ line: 1, char: 9 }, undefined, ["abc\n  \n"]),
          ),
          "  def",
        ]),
      );
