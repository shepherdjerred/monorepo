...
export function customProperty({ title, document }: RenderFunctionInput): React.ReactNode {
  // extract the body
  ...
  return <div style={twj("h-full w-full flex items-start justify-start border border-blue-500 border-[12px] bg-gray-50")}>
