import { checkPostMatch } from "@shepherdjerred/scout-backend/league/tasks/postmatch/index.ts";
import { runLifecycleCheck } from "@shepherdjerred/scout-backend/league/tasks/competition/lifecycle.ts";
import { runDailyLeaderboardUpdate } from "@shepherdjerred/scout-backend/league/tasks/competition/daily-update.ts";
import { runPlayerPruning } from "@shepherdjerred/scout-backend/league/tasks/cleanup/prune-players.ts";
import { checkAbandonedGuilds } from "@shepherdjerred/scout-backend/league/tasks/cleanup/abandoned-guilds.ts";
import { runDataValidation } from "@shepherdjerred/scout-backend/league/tasks/cleanup/validate-data.ts";
import { refreshMatchTimes } from "@shepherdjerred/scout-backend/league/tasks/maintenance/refresh-match-times.ts";
import { runWeeklyPairingUpdate } from "@shepherdjerred/scout-backend/league/tasks/pairing/index.ts";
import { client } from "@shepherdjerred/scout-backend/discord/client.ts";
import { createCronJob } from "@shepherdjerred/scout-backend/league/cron/helpers.ts";
import { createLogger } from "@shepherdjerred/scout-backend/logger.ts";
import { getFlag, MY_SERVER } from "@shepherdjerred/scout-backend/configuration/flags.ts";
