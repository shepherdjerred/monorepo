 ...
 *   - `author-excluded`: the PR author is in Greptile's excluded authors list
 *     (observed phrase: "PR author is in the excluded authors list.").
 *     Renovate and other bots are typically excluded.
 *
