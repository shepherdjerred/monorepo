...
import { handleCommands } from "@shepherdjerred/scout-backend/discord/commands/index.ts";
import {
  discordConnectionStatus,
  discordGuildsGauge,
  discordUsersGauge,
  discordLatency,
} from "@shepherdjerred/scout-backend/metrics/index.ts";
import { handleGuildCreate } from "@shepherdjerred/scout-backend/discord/events/guild-create.ts";
