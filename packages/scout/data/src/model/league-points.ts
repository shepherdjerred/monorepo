...
import { z } from "zod";
import { numberOfDivisions } from "@shepherdjerred/scout-data/model/division";
import type { Rank } from "@shepherdjerred/scout-data/model/rank";
import type { Tier } from "@shepherdjerred/scout-data/model/tier";
