...
} from "#src/trpc/router/competitions/competition-edit-input.ts";
...
import { competitionAnalysisProcedures } from "#src/trpc/router/competitions/competition-analysis-procedures.ts";
import { competitionDeliveryProcedures } from "#src/trpc/router/competitions/competition-delivery-procedures.ts";
import {
