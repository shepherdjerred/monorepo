...
import { MY_SERVER } from "@shepherdjerred/scout-backend/configuration/flags.ts";
import { send as sendChannelMessage } from "@shepherdjerred/scout-backend/league/discord/channel.ts";
import { splitMessageIntoChunks } from "@shepherdjerred/scout-backend/discord/utils/message.ts";
import {
