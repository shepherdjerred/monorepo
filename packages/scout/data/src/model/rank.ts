import { z } from "zod";
import { DivisionSchema, divisionToString } from "@shepherdjerred/scout-data/model/division.ts";
import { TierSchema, type Tier } from "@shepherdjerred/scout-data/model/tier.ts";
import { rankToLeaguePoints, tierToOrdinal } from "@shepherdjerred/scout-data/model/league-points.ts";
import { startCase } from "@shepherdjerred/scout-data/util.ts";
