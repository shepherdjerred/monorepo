...
- PR #1645 is merged and the live entity rename was recorded complete.

### Remaining

- None in this implementation plan. Physical dock-sensor polarity checks are
  tracked in `packages/docs/todos/roborock-dock-alert-polarity-verification.md`;
  Apple Home cleanup remains in
  `packages/docs/todos/homekit-device-room-renames.md`.
