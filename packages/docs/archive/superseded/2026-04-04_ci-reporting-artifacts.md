...
The reporting need remains, but this Dagger-era implementation is superseded.
Current static-Buildkite work is split into:

- `packages/docs/todos/ci-junit-test-engine-reporting.md`
- `packages/docs/todos/ci-coverage-reporting.md`
- `packages/docs/todos/ci-failure-annotations.md`

## Comment Log

- 2026-07-27 — Board audit verified JUnit, coverage, and failure-reporting gaps
  remain while `.dagger/` and `scripts/ci/` are gone. Closed this mixed plan and
  preserved each outcome as an independently actionable current-era todo.
