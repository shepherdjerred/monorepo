...
class CdDirectoryP3Test {
    ...
    void scenario_C5() {
        ...
        assertEquals(d("L2M="), solver.cd("/", "/a", "/home/default", symlinks));
    }
    ...
    void scenario_C7() {
        ...
        assertEquals(d("L3ovdw=="), solver.cd("/", "/z/w", "/home/default", symlinks));
    }

    @Test
    void scenario_C8() {
        var symlinks = Map.of("/home/user/bin", "/opt/bin");
        assertEquals(d("L29wdC9iaW4="), solver.cd("/tmp", "~/bin", "/home/user", symlinks));
    }

    @Test
    void scenario_C9() {
        var symlinks = Map.of("/link", "/target");
        assertEquals(d("L3RhcmdldA=="), solver.cd("/", "link", "/home/default", symlinks));
    }
    ...
    @Test
    void scenario_C11() {
        assertEquals(d("L2EvYy9k"), solver.cd("/a/b", "../c/./d", "/home", Map.of()));
    }
}
