...
[HTTP adapter](https://github.com/shepherdjerred/monorepo/blob/995f3d3ced2de1040a150e15aeb467a636269b4c/packages/temporal/src/event-bridge/agent-chat-api.ts),
[Discord adapter](https://github.com/shepherdjerred/monorepo/blob/995f3d3ced2de1040a150e15aeb467a636269b4c/packages/temporal/src/event-bridge/agent-chat-discord.ts),
...
The [HTTP route implementation](https://github.com/shepherdjerred/monorepo/blob/995f3d3ced2de1040a150e15aeb467a636269b4c/packages/temporal/src/event-bridge/agent-chat-api.ts)
...
- `/agent continue prompt:<text> [chat:<chatId>]` continues the active chat or
  selects any cataloged chat by ID.
...
[command definition and authorization handler](https://github.com/shepherdjerred/monorepo/blob/995f3d3ced2de1040a150e15aeb467a636269b4c/packages/temporal/src/event-bridge/agent-chat-discord.ts)
enforce both checks.

Production injects `AGENT_CHAT_DISCORD_TOKEN` from the Temporal worker's
1Password item. Local gateways without it still start and log that Discord
ingress was skipped. This token is for the dedicated durable-chat application;
do not reuse another bot's token. The
[control worker manifest](https://github.com/shepherdjerred/monorepo/blob/995f3d3ced2de1040a150e15aeb467a636269b4c/packages/homelab/src/cdk8s/src/resources/temporal/workers/ingress-workers.ts)
owns the secret injection.
