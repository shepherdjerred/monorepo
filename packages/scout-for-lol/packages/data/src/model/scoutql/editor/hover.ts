...
} from "#src/model/scoutql/analyze/analyze.ts";
import {
  containsErrorNode,
  forEachExprNode,
...
import { scoutQlSourceCatalog } from "#src/model/scoutql/catalog/catalog-columns.ts";
import {
  scoutQlFunction,
  type ScoutQlFunctionInfo,
} from "#src/model/scoutql/catalog/catalog-functions.ts";
import {
  scoutQlContextAt,
  scoutQlTokenAt,
} from "#src/model/scoutql/editor/editor-context.ts";
import { printScoutQlExpr } from "#src/model/scoutql/editor/format-expr.ts";
import { scoutQlQueryExprs } from "#src/model/scoutql/parse/query-exprs.ts";
import {
